...
import { Container, HeroCover, Skeleton, Text } from '@components/ui'
...
export default function Search({ categories, brands }: SearchPropsType) {
  ...
  // console.log('navbar', navBarlinks)

  return (
    <HeroCover withBanner={false}>
      {/* <CloudNavBar pages={navBarlinks} /> */}
      <Text variant="heading" className="text-center capitalize">
        {category}
      </Text>
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 mt-3 mb-20">
          ...
          <div className="col-span-8 order-3 lg:order-none">
            ...
            {data ? (
              <div className="grid grid-cols-2 gap-8 sm:grid-cols-2 lg:grid-cols-3 px-5">
